...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn("text-sm text-blue-100/80", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "mt-2 border-white/15 bg-white/0 text-white hover:bg-white/10 sm:mt-0",
      className,
    )}
    {...props}
  />
